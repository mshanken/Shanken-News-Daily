<div id="sidebar" class="one_third">
		...
		<div class="widget-container" id="ad-tablet">
			<a href="http://www.winespectator.com/micro/show?id=40690" title="The 36th annual Impact Marketing Seminar - March 22, 2012"><img src="<?php bloginfo('template_url'); ?>/img/IMP-MS2011-189x150.jpg" alt="The 36th annual Impact Marketing Seminar - March 22, 2012" /></a></div>
	...
	if ( ! dynamic_sidebar( 'primary-widget-area' ) ) : ?>
		...
		<div class="widget-container">
			<h3 class="widget-title">FOLLOW US</a></h3>
				<ul id="socialicons">
					<li><a href="http://twitter.com/#!/ShankenNews"><img src="<?php bloginfo('template_url'); ?>/img/twitter.png" alt="Shanken News Daily on Twitter" title="Shanken News Daily on Twitter"/></a></li>
					<li><a href="http://www.facebook.com/#!/pages/Shanken-News-Daily/187376324643407"><img src="<?php bloginfo('template_url'); ?>/img/facebook.png" alt="Shanken News Daily on Facebook" title="Shanken News Daily on Facebook"/></a></li>
				</ul>
		</div><!--/widget-container-->
<?php
