...
?>
	...
	<p><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'twentyten' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"', $total_images); ?></p>
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
	<p><?php next_posts_link( __( '&larr; Older posts', 'twentyten' ) ); ?><span id="nextlink"><?php previous_posts_link( __( 'Newer posts &rarr;', 'twentyten' ) ); ?></span></p>
